...
namespace JSONAPI.Tests.Payload
{
    ...
    public class ErrorSerializerTests : JsonApiSerializerTestsBase
    {
        ...
        public async Task Serialize_error_with_only_id()
        {
            ...
            await AssertSerializeOutput(serializer, error.Object, "Payload/Fixtures/Serialize_error_with_only_id.json");
        }
        ...
        public async Task Serialize_error_with_all_possible_members()
        {
            ...
            await AssertSerializeOutput(serializer, error.Object, "Payload/Fixtures/Serialize_error_with_all_possible_members.json");
        }
    }
}
